...
- `orders` table stores account id, lifecycle state, base quantity, optional quote quantity, and optional stop price.
...
- `engine_snapshots` stores replay checkpoints with the last covered event journal id.
